	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">基于SpringBoot社区团购平台的设计与实现</span>
				</div>
		...
		<el-dialog title="AI智能导购" :visible.sync="chatFormVisible" width="60%" :before-close="chatClose">
	...
	.main-containers {
		.body-containers {
			...
			.top-container {
				...
				top: 0;
				left: 0;
				background: linear-gradient(0deg, rgba(255,109,109,1) 0%, rgba(255,140,140,1) 100%);
				width: 100%;
