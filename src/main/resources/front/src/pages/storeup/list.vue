<template>
	<div :style='{"alignContent":"flex-start","padding":"0 10%","margin":"0px auto","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":" 0 0 0 10px","borderColor":"#ff6d6d","margin":"20px 0 10px 0","color":"#333","borderWidth":"0 0 0 6px","width":"auto","lineHeight":"1","fontSize":"32px","borderStyle":"solid"}'>我的收藏</div>
		<div v-if="storeupType==21" class="section-title" :style='{"padding":" 0 0 0 10px","borderColor":"#ff6d6d","margin":"20px 0 10px 0","color":"#333","borderWidth":"0 0 0 6px","width":"auto","lineHeight":"1","fontSize":"32px","borderStyle":"solid"}'>我的点赞</div>
		<div v-if="storeupType==81" class="section-title" :style='{"padding":" 0 0 0 10px","borderColor":"#ff6d6d","margin":"20px 0 10px 0","color":"#333","borderWidth":"0 0 0 6px","width":"auto","lineHeight":"1","fontSize":"32px","borderStyle":"solid"}'>我的评论</div>
