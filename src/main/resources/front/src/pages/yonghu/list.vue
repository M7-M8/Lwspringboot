		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				...
				<el-form-item class="list-item" >
					...
					<el-select v-model="formSearch.shequ" placeholder="请选择社区" :clearable="true">
						<el-option v-for="(item, index) in shequOptions" :key="index" :label="item" :value="item"></el-option>
					</el-select>
				</el-form-item>
...
<script>
	...
	export default {
		...
		async created() {
			...
			await this.$http.get('option/shequxinxi/shequ').then(res => {
				if (res.data.code == 0) {
