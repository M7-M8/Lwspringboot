<template>
	<div :style='{"width":"100%","padding":"20px 10% 40px","margin":"10px auto","position":"relative","background":"none"}'>
		...
		<div class="section-title" :style='{"padding":" 0 0 0 10px","borderColor":"#ff6d6d","margin":"20px 0 10px 0","color":"#333","borderWidth":"0 0 0 6px","width":"auto","lineHeight":"1","fontSize":"32px","borderStyle":"solid"}'>我的订单</div>
		<el-tabs v-model="ordertype" @tab-click="handleClick2">
			<el-tab-pane label="配送" name="1"></el-tab-pane>
			<el-tab-pane label="自提" name="2"></el-tab-pane>
		</el-tabs>
		<el-tabs v-model="activeName" @tab-click="handleClick">
			...
			<el-tab-pane v-if="ordertype==1" label="已发货" name="已发货"></el-tab-pane>
	...
	export default {
		...
		methods: {
			...
			handleClick2(tab, event) {
				if(this.ordertype==2&&this.activeName=='已发货') {
					this.activeName = '已支付'
				}
				this.getMyOrderList(1);
			},
			...
			getMyOrderList(page) {
				...
				params.ordertype = Number(this.ordertype)
