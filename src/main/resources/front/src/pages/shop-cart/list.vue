<template>
	<div :style='{"width":"100%","padding":"20px 10% 40px","margin":"10px auto","position":"relative","background":"none"}'>
		<div class="section-title" :style='{"padding":" 0 0 0 10px","borderColor":"#ff6d6d","margin":"20px 0 10px 0","color":"#333","borderWidth":"0 0 0 6px","width":"auto","lineHeight":"1","fontSize":"32px","borderStyle":"solid"}'>购物车</div>
