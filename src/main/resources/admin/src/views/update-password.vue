<template>
	<div :style='{"minHeight":"100vh","padding":"0 30px 30px","background":"none"}'>
		<el-form
			v-if="showType==1"
			...
			label-width="180px"
		>
			<el-form-item :style='{"width":"calc(100% - 0px)","margin":"10px 0px 10px 0 ","display":"flex"}' label="原密码" prop="password">
				<el-input type="password" v-model="ruleForm.password" ></el-input>
			</el-form-item>
			<el-form-item :style='{"width":"calc(100% - 0px)","margin":"10px 0px 10px 0 ","display":"flex"}' label="新密码" prop="newpassword">
				<el-input type="password" v-model="ruleForm.newpassword" ></el-input>
			</el-form-item>
			<el-form-item :style='{"width":"calc(100% - 0px)","margin":"10px 0px 10px 0 ","display":"flex"}' label="确认密码" prop="repassword">
			...
			<el-form-item :style='{"width":"auto","padding":"0 30px","margin":"20px  auto 30px auto","flexWrap":"wrap","justifyContent":"center","display":"flex"}'>
				<el-button class="btn3" :style='{"border":"0px solid #206cb4","cursor":"pointer","padding":"0 24px","margin":"4px","color":"#fff","minWidth":"176px","outline":"none","borderRadius":"24px  24px  24px  24px","background":"#333333","width":"auto","fontSize":"16px","fontWeight":"bold","height":"47px"}' type="primary" @click="onUpdateHandler">
