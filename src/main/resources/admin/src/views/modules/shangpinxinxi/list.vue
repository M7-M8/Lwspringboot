		...
		<template v-if="showFlag ">
			<el-form class="center-form-pv" :style='{"width":"100%","padding":"0","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"100%","position":"relative","borderRadius":"24px","flexWrap":"wrap","background":"none","display":"flex"}' >
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">商品名称</label>
						<el-input v-model="searchForm.shangpinmingcheng" placeholder="商品名称" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}' class="select" label="商品分类" prop="shangpinfenlei">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">商品分类</label>
					...
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">品牌</label>
						<el-input v-model="searchForm.pinpai" placeholder="品牌" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">店铺名</label>
						<el-input v-model="searchForm.dianpuming" placeholder="店铺名" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">最小价格</label>
					...
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}' :label="'至'">
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","display":"inline-block","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">最大价格</label>
			...
			<div :style='{"border":"0px solid #e9eafc","width":"100%","padding":" 0px 15px 20px 0","boxShadow":"none","borderRadius":"10px","background":"#fff"}'>
				<el-table class="tables"
					...
					<el-table-column :resizable='true' :sortable='true'
						class-name="showColor1"						prop="alllimittimes"
						label="库存">
						<template slot-scope="scope">
		...
		methods: {
			...
			tableRowClassName({
			  ...
			  rowIndex
				...
				if((Number('0')<Number('10')&&row.alllimittimes>=Number('0')&&row.alllimittimes<=Number('10'))||(Number('0')>Number('10')&&(row.alllimittimes>=Number('0')||row.alllimittimes<=Number('10')))) {
					name = name + ' ' + 'alllimittimes-row';
				}
				return name;
			},
			changeClick(e) {
				// 提醒标题有吗
				this.searchForm.shangpinmingcheng = e
				this.search()
				// 关闭弹窗
				this.$msgbox.close()
			},
...
<style lang="scss" scoped>
	...
	/deep/ .el-table .alllimittimes-row .showColor1 {
