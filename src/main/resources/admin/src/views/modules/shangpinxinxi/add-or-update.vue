		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="商品分类" prop="shangpinfenlei" >
					<el-select :disabled="ro.shangpinfenlei" v-model="ruleForm.shangpinfenlei" placeholder="请选择商品分类"  filterable>
						<el-option
				...
				<el-form-item v-else class="input" label="团购价" prop="groupprice" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="拼团人数" prop="grouppeople" >
					<el-input v-model.number="ruleForm.grouppeople" placeholder="拼团人数" clearable  :readonly="ro.grouppeople"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="拼团人数" prop="grouppeople" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="当前人数" prop="curpeople" >
					<el-input v-model.number="ruleForm.curpeople" placeholder="当前人数" clearable  :readonly="ro.curpeople"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="当前人数" prop="curpeople" >
					<el-input v-model="ruleForm.curpeople" placeholder="当前人数" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'" class="editorBox" label="商品描述" prop="shangpinmiaoshu" >
				<editor 
			...
			<el-form-item v-else-if="ruleForm.shangpinmiaoshu" label="商品描述" prop="shangpinmiaoshu"  class="textBox">
				<span class="text ql-snow ql-editor" v-html="ruleForm.shangpinmiaoshu"></span>
			</el-form-item>
		...
		methods: {
			...
			init(id,type ) {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						var json = data.data;
						if(((json.dianpuming!=''&&json.dianpuming) || json.dianpuming==0) && this.sessionTable!="users"){
			...
			async info(id) {
				await this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shangpinmiaoshu = this.ruleForm.shangpinmiaoshu.replace(reg,'../../../Lwspringboot/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					if (Number(this.ruleForm.alllimittimes)<Number(this.ruleForm.grouppeople)){
						this.$message.error("库存必须大于团购人数");
						return
					}
					if (Number(this.ruleForm.alllimittimes)%Number(this.ruleForm.grouppeople)!=0) {
						this.$message.error("库存必须是团购人数的倍数");
						return
					}
